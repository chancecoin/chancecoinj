...
rm -Rf classes
mkdir release_server
mkdir release_server/update
mkdir classes
mkdir classes/resources
cp -R ../resources/templates classes/resources/
cp -R ../resources release_server/
mkdir release_server/resources/db
rm -Rf release_server/resources/templates
rm -Rf release_server/resources/templates_chancecoin.com
rm release_server/resources/db/*
