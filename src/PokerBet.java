...
//	static Logger logger = LoggerFactory.getLogger(PokerBet.class);
//	public static Integer length = 4+8+9*2;
//	public static Integer id = 41;
//
...
//						}
//					}
//					db.executeUpdate("insert into bets_poker(tx_index, tx_hash, block_index, source, bet, chance, payout, profit, cha_supply, validity, cards) values('"+txIndex.toString()+"','"+txHash+"','"+blockIndex.toString()+"','"+source+"','"+bet.toString()+"','"+chance.toString()+"','"+payout.toString()+"','0','"+chaSupply.toString()+"','"+validity+"','"+deal.toString()+"')");
//				}				
//			}
